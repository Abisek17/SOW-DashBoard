...
@CrossOrigin(origins = {"http://localhost:8080","https://sow-dash-board-2huhxd3ri-abiseks-projects-56e72be1.vercel.app","https://sow-dashboard.onrender.com", "http://127.0.0.1:5501", "http://localhost:5501"}) // Allows requests from your frontend (adjust if frontend runs on a different port/domain)
